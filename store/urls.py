...
urlpatterns = [    # Creating some URL patterns
    path('', views.product_all, name='product_all'),   # all_products is a name of a ftn in views.py
    path('<slug:slug>', views.product_detail, name='product_detail'),   #The first slug refers to the type of the data and second one to the variable
